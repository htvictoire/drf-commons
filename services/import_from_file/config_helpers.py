...
class ConfigHelpers:
    ...
    @staticmethod
    def create_simple_config(model_path: str, field_mappings: Dict[str, str], 
                           file_format: str = "xlsx", unique_by: List[str] = None) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def validate_transforms_needed(config: Dict[str, Any], transforms: Dict[str, callable]) -> List[str]:
        """

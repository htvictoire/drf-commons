...
DEBUG_LOG_FILE_MAX_BYTES = _settings.get('DEBUG_LOG_FILE_MAX_BYTES', 10 * 1024 * 1024)  # 10MB
DEBUG_LOG_BACKUP_COUNT = _settings.get('DEBUG_LOG_BACKUP_COUNT', 5)
DEBUG_LOG_DEBUG_FILE_MAX_BYTES = _settings.get('DEBUG_LOG_DEBUG_FILE_MAX_BYTES', 20 * 1024 * 1024)  # 20MB
DEBUG_LOG_ERROR_FILE_MAX_BYTES = _settings.get('DEBUG_LOG_ERROR_FILE_MAX_BYTES', 5 * 1024 * 1024)  # 5MB
...
DEBUG_LOG_SPECIFIC_FILE_MAX_BYTES = _settings.get('DEBUG_LOG_SPECIFIC_FILE_MAX_BYTES', 5 * 1024 * 1024)  # 5MB
...
# Security settings
DEBUG_SENSITIVE_HEADERS = _settings.get('DEBUG_SENSITIVE_HEADERS', ['authorization', 'cookie', 'x-api-key'])
...
DEBUG_ENABLED_LOG_CATEGORIES = _settings.get('DEBUG_ENABLED_LOG_CATEGORIES', [
    # System handlers (can be disabled by users)
    'console', 'main', 'errors', 'database_slow',
    # Debug categories
    'users', 'api', 'database', 'models', 'cache', 'performance', 'requests'
])

# Categories allowed in production environments when Django DEBUG=False
DEBUG_PRODUCTION_SAFE_CATEGORIES = _settings.get('DEBUG_PRODUCTION_SAFE_CATEGORIES', [
    'errors', 'performance', 'database', 'models'
])

...
from drf_common.common_tests.base_cases import ModelTestCase

from ..person import AddressMixin, BasePerson, IdentityMixin
...
class BasePersonModelForTesting(BasePerson):
    """Test model using BasePerson."""
...
class BasePersonTests(ModelTestCase):
    """Tests for BasePerson model."""

    def test_get_display_info(self):
        """Test get_display_info returns correct information."""
        model = BasePersonModelForTesting(
            first_name="John",
            last_name="Doe",

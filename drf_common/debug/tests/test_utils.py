...
from drf_common.common_tests.base_cases import DrfCommonTestCase
from drf_common.common_tests.factories import UserFactory
from drf_common.common_tests.utils import capture_logs, override_debug_settings

from drf_common.debug.utils import (
    analyze_queryset,
...
class TestDebugSqlQueries(DrfCommonTestCase):
    ...
    @patch("builtins.print")
    @patch("drf_common.debug.utils.connection")
...
class TestMemoryUsage(DrfCommonTestCase):
    ...
    @patch("drf_common.debug.utils.psutil")
